...
class textCnnConfig():
    def __init__(self,
        ...
        self.input_file = os.path.join('data', sign, 'data.tsv')
        self.vocab_file = vocab_file
        self.label_file = os.path.join(self.output_dir, sign, 'label.json')
        ...
        self.checkpoint_dir = os.path.join(self.output_dir, sign)
...
def textCnnModel(config,
    ...
    if restore and os.path.join(config.checkpoint_dir, 'textcnn_model.h5'):
        model.load_weights(os.path.join(config.checkpoint_dir, 'textcnn_model.h5'))
