...
flags.DEFINE_string("data_dir", default="sota/pretrained_xl/tf_enwik8/data/tfrecords",
                    help="Path to tf-records directory.")
flags.DEFINE_string("record_info_dir", default="sota/pretrained_xl/tf_enwik8/data/tfrecords",
                    help="Path to local directory containing filenames.txt.")
flags.DEFINE_string("corpus_info_path", default="sota/pretrained_xl/tf_enwik8/data/corpus-info.json",
                    help="Path to corpus-info.json file.")
flags.DEFINE_string("model_dir", default="EXP-enwik8",
...
flags.DEFINE_string("eval_ckpt_path", "sota/pretrained_xl/tf_enwik8/model/model.ckpt-0",
    ...
    if FLAGS.do_eval_only:
        if FLAGS.eval_ckpt_path is not None:
            ...
            for eval_checkpoint in ckpt_state.all_model_checkpoint_paths:
                if not tf.gfile.Exists(eval_checkpoint + ".index"): continue
